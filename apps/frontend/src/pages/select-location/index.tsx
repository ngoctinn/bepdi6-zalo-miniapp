    ...
    <div className="flex flex-col gap-3 p-3.5 pb-28">
      {isCreating ? (
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative flex flex-col gap-1.5 pt-1">
            <div className="flex items-center justify-between px-1">
              <span className="text-xs font-semibold text-neutral800">
                {copy.selectLocation.searchLabel}
              </span>
            </div>
            ...
            {showSuggestions && debouncedSearch.length >= 2 && (
              <div className="absolute left-0 right-0 top-full z-[500] mt-1 max-h-60 overflow-y-auto rounded-xl border border-black/[0.08] bg-white p-1.5 shadow-xl">
                {isSearching ? (
                  <div className="flex items-center justify-center gap-2 py-4 text-xs text-neutral500">
                  ...
                  <div className="py-4 text-center text-xs text-neutral400">
          ...
          {/* 2. Bản đồ chọn vị trí trực quan */}
          <div className="flex flex-col gap-1.5 pt-1">
            <div className="flex items-center justify-between px-1">
              <span className="text-xs font-semibold text-neutral800">
                {copy.selectLocation.mapLabel}
              </span>
          ...
          <div className="flex flex-col gap-2 pt-1">
            <div className="flex items-center justify-between px-1">
              <span className="flex items-center gap-1 text-xs font-semibold text-neutral800">
                <span>{copy.selectLocation.nameLabel}</span>
                <span className="text-red-500">*</span>
              </span>
              {isZaloRuntime() && (
                <button
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between px-1">
              <span className="flex items-center gap-1 text-xs font-semibold text-neutral800">
                <span>{copy.selectLocation.phoneLabel}</span>
                <span className="text-red-500">*</span>
              </span>
              {isZaloRuntime() && (
                <button
