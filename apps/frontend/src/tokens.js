...
const semantic = {
  ...
  text: {
    ...
    selectLocation: {
      ...
      houseNumberLabel: "Số nhà, tên tòa nhà, số phòng",
      houseNumberPlaceholder:
        "Ví dụ: 45, hoặc 123/45, P.402 Chung cư Botanica...",
      streetLabel: "Tên đường, phường, quận (từ bản đồ / GPS)",
      locatingStreet: "Đang định vị...",
      editManual: "Sửa tay",
      doneManual: "Xong",
      streetPlaceholder: "Nhập tên đường, phường, quận...",
      noStreetHint:
        'Chưa có địa chỉ đường. Hãy kéo bản đồ, chọn gợi ý hoặc bấm "Lấy vị trí GPS".',
      fullAddressPreview: "Địa chỉ giao hàng đầy đủ (Shipper nhìn thấy):",
      searchLabel: "Tìm kiếm địa điểm / địa chỉ",
      searchPlaceholder: "Tìm chung cư, tên đường, địa danh...",
    },
    staff: {
