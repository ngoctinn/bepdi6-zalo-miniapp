  ...
  text: {
    ...
    order: {
      ...
      stepper: {
        ...
        cooking: "Đang nấu",
        delivering: "Đang giao",
        waitingPickup: "Chờ lấy món",
      },
      statusMessages: {
        pending: "Quán đã nhận đơn và đang kiểm tra...",
        preparing: "Bếp Dì 6 đang chuẩn bị món thơm ngon cho bạn...",
        readyPickup: "Món đã nấu xong, mời bạn đến quầy nhận nhé!",
        delivering: "Shipper đang trên đường giao đồ ăn đến bạn...",
      },
      totalItemsLabel: "Tổng ({count} món):",
      andOtherItems: "và {count} món khác...",
      orderCodePrefix: "Đơn hàng #",
      empty: "Chưa có đơn hàng nào",
      detail: "Xem chi tiết",
      reorder: "Đặt lại",
      reorderSuccess: "Đã thêm các món vào giỏ hàng!",
      cancelOrder: "Hủy đơn",
    ...
    selectLocation: {
      ...
      namePlaceholder: "Họ và tên người nhận",
      getNameZalo: "Lấy từ Zalo",
      phoneLabel: "Số điện thoại nhận hàng",
      phonePlaceholder: "Số điện thoại di động",
      getPhoneZalo: "Lấy từ Zalo",
      addressLabel: "Địa chỉ chi tiết",
      addressPlaceholder: "Số nhà, tên đường, phường, quận",
      getGpsButton: "Lấy vị trí hiện tại",
      gettingGpsButton: "Đang định vị...",
      gpsSuccess: "Đã xác định vị trí của bạn",
      gpsDenied:
        "Không thể lấy vị trí từ Zalo. Vui lòng tự chọn vị trí trên bản đồ.",
      cancel: "Hủy",
      save: "Lưu địa chỉ",
      ...
      errMissingAddress: "Vui lòng nhập địa chỉ nhận hàng",
      errGeneric: "Không thể thêm địa chỉ",
      houseNumberLabel: "Số nhà, tên tòa nhà",
      houseNumberPlaceholder: "Số nhà, số phòng, căn hộ",
      streetLabel: "Tên đường, khu vực",
      locatingStreet: "Đang định vị...",
      editManual: "Sửa",
      doneManual: "Xong",
      streetPlaceholder: "Tên đường, phường, quận",
      noStreetHint:
        "Chưa có địa chỉ đường. Vui lòng chọn trên bản đồ hoặc tìm kiếm.",
      fullAddressPreview: "Địa chỉ đầy đủ:",
      searchLabel: "Tìm kiếm địa chỉ",
      searchPlaceholder: "Tìm theo tên đường, tòa nhà, địa danh...",
      mapLabel: "Vị trí trên bản đồ",
      recipientSectionTitle: "Thông tin người nhận",
      locationSectionTitle: "Địa chỉ nhận món",
    },
    staff: {
      title: "Bếp Dì 6 - Quản lý đơn",
      soundOnSuccess: "Đã bật chuông báo đơn mới",
      soundUnsupported: "Thiết bị không hỗ trợ Web Audio",
      soundOff: "Đã tắt chuông báo",
      soundBtnOn: "Chuông",
      soundBtnOff: "Tắt",
      soundBtnTitleOn: "Tắt chuông báo",
      soundBtnTitleOff: "Bật chuông báo",
      ...
      actions: {
        confirmAndCook: "Nhận đơn",
        cookedReady: "Nấu xong",
        handoverShipper: "Giao shipper",
        pickupHandover: "Trả món",
        customerPickedUp: "Trả món",
        completeOrder: "Hoàn tất",
        orderEnded: "Đã kết thúc",
        cancel: "Hủy",
        call: "Gọi",
      },
      itemsSection: "Chi tiết món cần nấu",
      customerNotePrefix: "LƯU Ý CỦA KHÁCH:",
      customerHeader: "Khách:",
      customerLabel: "Khách hàng",
      orderNoteHeader: "Ghi chú: ",
      itemWarningPrefix: "Lưu ý: ",
      callCustomerBtn: "Gọi khách",
      printBagReceiptBtn: "In phiếu dán túi",
      cancelOrderBtn: "Hủy đơn",
      updateShipperBtn: "Cập nhật shipper",
      customerAddressFallback: "Địa chỉ khách hàng",
      deliveryType: {
        delivery: "Giao tận nơi",
        pickup: "Tại quán",
      },
      payment: {
        ...
        paid: "ĐÃ TT",
        unpaid: "CHƯA TT",
        paidOnlineBadge: "Đã thanh toán online",
        cashOnDeliveryBadge: "Thu tiền mặt khi giao",
      },
      aging: {
        justNow: "Vừa xong",
      ...
      financialShield: {
        paidOnline: "ĐÃ THANH TOÁN ONLINE",
        collectCod: "THU TIỀN MẶT COD:",
        neverCollect: "CẤM THU THÊM",
        driverMustCollect: "TÀI XẾ CẦN THU",
      },
      dispatch: {
        title: "Điều Phối Giao Hàng",
        deliverTo: "Giao đến:",
        selectChannel: "Chọn kênh điều phối",
        internalShipper: "Shipper Quán",
        internalDesc: "Nhân viên nội bộ",
        ahamoveFeeLabel: "Phí theo app",
        grabDesc: "Gọi ngoài app",
        quickSelectLabel: "Chọn nhanh nhân viên giao",
        quickSelectHint: "1-tap điền thông tin",
        shipperNameLabel: "Tên người giao",
        shipperPhoneLabel: "Số điện thoại",
        driverLicenseLabel: "Tài xế / Biển số",
        driverPhoneLabel: "SĐT Tài xế",
        trackingCodeLabel: "Mã theo dõi chuyến (Tracking Code)",
        driverAhamoveDefault: "Tài xế Ahamove",
        driverGrabDefault: "Tài xế Grab",
        driverGrabExpressDefault: "Tài xế GrabExpress",
        shipperInternalDefault: "Shipper quán",
        shipperNamePlaceholder: "Tên shipper...",
        shipperPhonePlaceholder: "090...",
        driverAhaLicensePlaceholder: "VD: Tuấn - 59F1-12345",
        driverPhonePlaceholder: "SĐT tài xế...",
        trackingCodePlaceholder: "VD: AHA-982341...",
        dispatchingNote:
          "Khách sẽ nhận được ZNS thông báo mã chuyến & trạng thái shipper đang giao.",
        dispatchVia: "Điều phối xe qua",
        close: "Đóng",
        confirmDispatch: "Xác Nhận Xuất Đơn Giao",
        dispatching: "Đang điều phối...",
        changeShipper: "Đổi shipper",
        assignShipper: "Gọi shipper",
      },
      cancel: {
        title: "Xác nhận hủy đơn hàng",
        prompt: "Vui lòng chọn lý do hủy đơn",
        back: "Quay lại",
        confirm: "Xác nhận hủy",
        cancelling: "Đang hủy...",
        customPlaceholder: "Nhập lý do chi tiết...",
        otherReasonKey: "Khác",
        reasons: [
          "Quán quá tải món",
          "Đã hết nguyên liệu",
        ...
        staffDefault: "Nhân viên hủy đơn",
      },
      toasts: {
        statusUpdateSuccess: "Đã cập nhật trạng thái đơn hàng thành công",
        statusUpdateError: "Không thể cập nhật đơn",
        cancelSuccess: "Đã hủy đơn",
        cancelError: "Không thể hủy đơn hàng",
        dispatchSuccess: "Đã điều phối đơn",
        dispatchError: "Không thể điều phối đơn hàng",
        refreshSuccess: "Đã làm mới dữ liệu!",
        copiedId: "Đã sao chép Zalo User ID!",
      },
      accessDenied: {
        title: "Yêu cầu quyền Quản trị / Bếp",
        desc: "Tài khoản của bạn chưa được cấp quyền Quản trị viên. Hãy thêm ID Zalo của bạn vào danh sách quản trị viên trên hệ thống.",
        zaloIdLabel: "Zalo User ID của bạn:",
        copyId: "Sao chép ID",
        refreshButton: "Làm mới quyền",
      ...
      items: {
        sectionTitle: "Món cần làm",
        itemCountPrefix: "Danh sách món",
        collapse: "Thu gọn danh sách",
        expand: "Bấm để xem chi tiết món",
      },
    },
    orderDetail: {
      ...
      processing: "Đang xử lý...",
      reorderButton: "Đặt lại đơn này",
      reorderSuccess: "Đã thêm món vào giỏ hàng",
      syncErrorHint:
        "Hệ thống đang đồng bộ hoặc kết nối bị gián đoạn. Bạn hãy nhấn thử tải lại nhé!",
      retryButton: "Thử tải lại",
      driverDeliveringTitle: "TÀI XẾ ĐANG GIAO ĐẾN BẠN",
      distancePrefix: "Khoảng cách: ~",
      driverMovingHint: "Vui lòng để ý điện thoại để nhận món nhé!",
      driverMovingDefault: "Tài xế đang di chuyển",
      callDriver: "Gọi tài xế",
      cashPreparedLabel: "Tiền mặt cần chuẩn bị:",
      paidOnlineNotice:
